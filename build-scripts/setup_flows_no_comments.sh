...
# Run once → creates ./node-red/ with 100% valid flows.json (no comments!)
# Tested and working on Node-RED 3.x and 4.x
...
echo "Creating clean Node-RED dev directory at $NODE_RED_DIR"
rm -rf "$NODE_RED_DIR"
mkdir -p "$NODE_RED_DIR"

# =============================================================================
# 1. Minimal settings.js (dev only)
# =============================================================================
...
# =============================================================================
# 2. 100% VALID flows.json (no comments, pure JSON)
# =============================================================================
cat > "$FLOWS_FILE" << 'EOF'
[
    {
...
echo ""
echo "Make sure your GasTrack API is running on port 8000 first!"
echo ""
